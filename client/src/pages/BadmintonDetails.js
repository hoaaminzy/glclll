...
const BadmintonDetails = () => {
  ...
  const dataFeedback = [
    {
      ...
      userId: "6651a52825cdf87641678c4e",
      badmintonId: "2",
  ...
  const filterFeedBack = dataFeedback.filter((fb) => fb.badmintonId === id);
          ...
          <Col sm={8}>
            <div>
              ...
              >
                ...
                >
                  Giá thuê :{post?.priceNu + " - " + post?.priceNam}
                </button>
              </div>
              <div className="py-4">
                ...
                <div className="fs-5 d-flex gap-2 align-items-center">
                  ...
                  <span>
                    {post?.dateStart?.date +
                      " / " +
                      post?.dateStart?.timeStart +
                      " đến " +
                      post?.dateStart?.timeEnd}
                  </span>
                </div>
                <div className="fs-5 d-flex gap-2 align-items-center">
